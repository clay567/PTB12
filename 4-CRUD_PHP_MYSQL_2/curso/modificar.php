<?php
	...
	//recepcion del parametro id enviado desde el archivo index.php
	$id = $_GET['id'];
	
	$sql = "SELECT * FROM personas WHERE id = '$id'";
	//$resultado es un objeto mysqli_result
...
<html lang="es">
	...
	<body>
		<div class="container">
			...
			<!--cargamos toda la infomarcion del usuario en base a su id ,luego hacemos alguna modificacion y enviamos los nuevos datos al archivo update.php-->
			<!--en la propiedad value de cada control colocamos los resultados correspondientes a cada campo-->
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
				...
				<!--select:si cumple la condicion pintamos el atributo selected del option con un echo-->
				<div class="form-group">
				...
				<!--radio:si cumple la condicion pintamos el atributo checked del input con un echo-->
				<div class="form-group">
				...
				<div class="form-group">
					...
					<!--strpos($pajar,$aguja):El valor entero devuelto representa la posicion de la primera instancia de aguja dentro de pajar. -->
					<!--En cualquier caso, si aguja no esta en la cadena, strpos() o strrpos() devolverán false, lo cual puede plantear un problema porque false en un lenguaje con control débil de tipos como php equivale a 0 ,es decir, al primer carácter de una cadena. Para evitar este problema podemos utilizar el operador === y probar los valores devueltos -->
					<div class="col-sm-10">
